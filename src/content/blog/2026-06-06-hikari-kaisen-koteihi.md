...
「スマホのキャリアに合わせて光回線を選ぶ」と、セット割で実質的にかなり安くなるケースが多いです。

主要キャリアとセット割の組み合わせはこんな感じです。

| スマホキャリア | 対応する光回線 |
|---|---|
| 楽天モバイル | 楽天ひかり（月1,100円割引） |
| docomo | ドコモ光（月最大1,100円割引） |
| au | auひかり（月最大1,100円割引） |
| SoftBank | SoftBank光（月最大1,100円割引） |

今使っているスマホキャリアを先に確認して、対応する光回線を探す順番が一番スムーズです。

乗り換えとセット割を組み合わせるだけで、実質的な月額がぐっと下がります。
