...
2. 検索窓に「オルカン」または「S&P500」と入力する
3. 候補に出てきた投資信託（例：eMAXIS Slim 全世界株式（オール・カントリー））を選ぶ
4. ファンドの詳細ページを開き、「積立注文」のボタンを押す
5. 注文画面で、NISA区分を「つみたて投資枠」に切り替える
6. 「決済方法」を「クレジットカード（楽天カード）」に切り替える

「オルカン」は正式名称が長くて最初は不安になりますが、検索窓に「オルカン」と打てばちゃんと候補に出てきます。
...
口座開設からこの記事と同じ流れでつみたて設定まで進めたい人は、<a href="https://ad2.trafficgate.net/t/r/1230/738/317992_397371" target="_blank" rel="nofollow sponsored noopener noreferrer">楽天証券でらくらく積立を始める（PR）</a>からまとめて申し込めます。
