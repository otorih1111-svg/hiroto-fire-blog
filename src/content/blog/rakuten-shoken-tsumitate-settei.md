...
description: "楽天証券のNISA積立設定のやり方を、初心者が実際に迷ったポイント込みで整理。つみたて投資枠の確認、クレカ積立、銘柄選び、ボーナス設定の注意点まで実録でまとめます。"
pubDate: 2026-06-13
category: 投資・FIRE
tags:
  - 楽天証券
...
結論だけ先に言うと、初期設定でやることは4つだけです。

1. つみたて投資枠が使える状態か確認する
2. 楽天カードをクレカ積立用に登録する
3. クレカ積立の上限額を決める
4. 銘柄を選んで積立注文を確定する
...
## ボーナス設定（増額設定）は、クレカ積立では使えない

「ボーナス月だけ多めに買いたい」という人向けに、楽天証券には年2回まで指定した月の買付額を増やせる「ボーナス設定（増額設定）」があります。

ぼくも設定画面で探したのですが、見つかりませんでした。

調べてわかったのは、**ボーナス設定は証券口座からの引落しなど現金決済のみで、クレカ積立（楽天カード決済）や楽天キャッシュでは使えない**ということです。

つまり、こういう整理になります。

- クレカ積立でポイントを取る → 毎月同じ額をコツコツ。ボーナス設定は使えない
- ボーナス月に増額したい → その分は決済方法を証券口座引落にした積立を別で設定する

ぼくは家計の管理をシンプルにしたかったので、クレカ積立の毎月定額だけにしました。

ボーナスで余裕が出た月は、無理に仕組みをいじらず「つみたて投資枠の上限に収まる範囲でスポット購入」くらいの気持ちでいます。

→ ボーナス設定の具体的な手順と、実際にやってみて気づいた注意点は
[楽天証券のボーナス設定のやり方｜やってみて気づいた注意点](/blog/2026-07-16-rakuten-bonus-settei/)にまとめました。
...
ちなみに、設定そのものより難しかったのは「教育費や保険とのバランスで、毎月いくらまで積立に回していいか」でした。

ぼくはそこが半年進まず、最終的にFP無料相談で1時間で整理してもらっています。
...
A. クレカ積立ではボーナス設定自体が使えません。使いたい場合は、決済方法を証券口座引落にした積立設定で、年2回までボーナス月を指定できます。詳しくは本文の「ボーナス設定」の章にまとめています。
