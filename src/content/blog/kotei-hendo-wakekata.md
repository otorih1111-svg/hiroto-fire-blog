---
title: "固定費と変動費の分け方｜家計を3つに分けた実例"
description: "固定費と変動費の分け方がわからず家計が把握できなかった40代シングルファーザーが、支出を3つに分けて月7,000円の余白を見つけた実例。分類の基準と、分けたあとにやることまで書きます。"
slug: "kotei-hendo-wakekata"
pubDate: 2026-06-09
updatedDate: 2026-07-22
category: 節約・家計
tags: ["固定費", "変動費", "家計管理", "シングルファーザー"]
draft: false
affiliate: false
ogImage: '/images/thumbnails/kotei-hendo-wakekata.png'
---

固定費と変動費の分け方が、正直よくわかっていなかった。

言葉は知っていても、自分の支出のどれがどっちなのか、一度も整理したことがなかった。

でも、支出を固定費・変動費・投資の3つに分けただけで、ぼくは月7,000〜8,000円の余白を見つけた。

そのうち7,000円を新NISAの積立に回して、月3,000円→月10,000円に増やすことができた。

特別なことは何もしていない。やったのは、支出をノートに書き出して3列に分けただけだ。

この記事では、固定費と変動費の分け方の基準と、分けて初めて気づいたことを書く。
...
- **固定費**：毎月ほぼ同じ金額がかかるもの（住宅ローン・光熱費・保険・サブスクなど）
...
| 分類 | 内容 | ぼくのチェックポイント |
|------|------|----------|
| **固定費** | 住宅ローン・光熱費・保険・サブスク | 削れるものを探す |
