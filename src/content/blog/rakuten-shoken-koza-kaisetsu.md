...
description: "楽天証券の口座開設は何日かかる？実際は入力15分・総合口座は数日（公式最短は翌営業日）・NISA利用開始まで2〜3週間でした。40代シングルファーザーがつまずいた点まで正直にまとめます。"
pubDate: 2026-06-11
category: 投資・FIRE
tags:
  - 楽天証券
...
先に、一番知りたいはずの答えから書きます。

| 工程 | かかった時間・日数 |
|---|---|
| 申し込みの入力（スマホ） | 約15分 |
| 総合口座の開設通知が届くまで | 申し込みから数日 |
| NISA口座が使えるまで | さらに1週間ちょっと（税務署の確認） |
| 積立を始められる状態まで | トータル2〜3週間 |

これはぼくの実測値です。

[楽天証券の公式案内](https://www.rakuten-sec.co.jp/web/account-flow/)では、「スマホで本人確認」を使えば最短で翌営業日にログインIDがメールで届くとされています。書類アップロード方式だと約5営業日後に郵送です。

「公式は翌営業日って言ってるのに、なんでぼくは数日かかったのか」

理由は単純で、本人確認の写真が不鮮明で差し戻され、その再提出を面倒がって数日放置したからです。

つまりこの表は「差し戻しメールを見なかったふりをした男の実測値」なので、普通にやればもっと早く終わります。

最短で終わらせるコツは3つだけです。

- 本人確認は「スマホで本人確認」（マイナンバーカード）を選ぶ
- 写真は明るい場所で、カードを机に置いて真上から撮る（一発で通す）
- NISA口座は申し込み時に同時にチェックを入れる（あと回しにすると税務署確認が二度手間）

それぞれの工程で実際に何をやったかは、ここから順番に書いていきます。
...
1. [ほったらかし投資の始め方｜投資が怖かった40代の新NISA入門](/blog/hottarakashi-investment-nisa-begin/)
...
A. 公式の案内では「スマホで本人確認」なら最短で翌営業日にログインIDが届きます。ただしNISA口座は税務署の確認が入るため、ぼくの場合は使えるようになるまでさらに1週間ちょっとかかりました。一番の時短は、本人確認写真の不備をなくして差し戻しを防ぐことです。
